...
resource "google_compute_network_firewall_policy_rule" "example_allow_xebia" {
  project         = var.project_id
...
resource "google_compute_network_firewall_policy_rule" "example_deny_all_ipv4" {
  project         = var.project_id
  firewall_policy = google_compute_network_firewall_policy.example.id
  priority        = 100000
...
resource "google_compute_network_firewall_policy_rule" "example_deny_all_ipv6" {
  project         = var.project_id
  firewall_policy = google_compute_network_firewall_policy.example.id
  priority        = 100001
